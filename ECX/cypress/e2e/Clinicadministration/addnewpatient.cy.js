/**
 * Test Suite: Clinic Admin - Add New Patient
 *
 * Purpose:
 * - Validate the functionality of adding a new patient including medical history, insurance, and additional details.
 * - Ensure proper handling of validations for required fields, duplicate emails, and invalid formats.
 *
 * Scenarios Covered:
 *
 * Positive Flows:
 * 1. Add a new patient with complete medical history, insurance, and additional information successfully.
 *
 * Negative Flows:
 * 2. Show validation errors when required fields are missing.
 * 3. Prevent adding a patient with a duplicate email.
 * 4. Show error for invalid email format.
 *
 * Expected Results:
 * - Patients should be created successfully with valid data and confirmation messages.
 * - Validations should trigger for missing or invalid data.
 * - Duplicate patients should be prevented with appropriate error messages.
 */

import { faker } from '@faker-js/faker';

describe('Clinic Admin - Add New Patient', () => {
  beforeEach(() => {
